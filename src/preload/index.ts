...
contextBridge.exposeInMainWorld("shortpath", {
  ...
  setCompactAlwaysOnTop: (value: boolean) => ipcRenderer.invoke("set-compact-always-on-top", value),
  setCompactSize: (value: number) => ipcRenderer.invoke("set-compact-size", value),
  setCompactAccentColor: (value: string | null) => ipcRenderer.invoke("set-compact-accent-color", value),
