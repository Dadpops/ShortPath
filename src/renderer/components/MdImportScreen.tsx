...
export default function MdImportScreen({ filePath, verticals, onComplete, onCancel }: Props) {
  ...
  async function handleImport() {
    ...
    try {
      await window.shortpath.commitMdImport(entries);
  ...
  return (
    <div className="md-import-shell">
      <div className="form-header">
        ...
        <span className="form-title">Import Markdown</span>
      </div>

      <div className="form-body import-body">
        {status === "loading" && <div className="import-status-msg">Reading file...</div>}
        ...
        {status === "ready" && sections.length === 0 && (
          <div className="import-status-msg">
            No headings found in this file. Try a Markdown file with ## or ### headings.
          </div>
        )}
